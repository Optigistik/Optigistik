                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#0C1D36] focus:border-transparent outline-none transition"
                                required
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#0C1D36] focus:border-transparent outline-none transition pr-10"
                                    required
                                />
                                <button
                                    type="button"
