...
import { createArticle } from '../../../lib/articleActions';
...
export default function NewArticlePage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        const author = getCurrentUserEmail() || 'Anonyme';
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-8 space-y-6">
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        <Link
                            href="/admin"
                            className="px-8 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-lg transition-colors text-center"
                        >
                            Annuler
                        </Link>
                    </div>
